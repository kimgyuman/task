...
<div class="row" >
	<div class="col-8">
	  <label for="exampleFormControlInput1" class="form-label" style="font-size:large;"  >제 &nbsp &nbsp &nbsp &nbsp  목</label>
  	  <input type="text" class="form-control" id="exampleFormControlInput1"  name="title_counsel">
	</div>
	<div class="col-4">
		<label for="inputCity" class="form-label" style="font-size:large;" >작 성 자</label>
		<input type="text" class="form-control" id="inputCity" name="writer_counsel">
    </div>
...
<div class="mb-3">
  ...
  <textarea class="form-control" id="exampleFormControlTextarea1" rows="7" name="content_counsel"></textarea>
  <div class="btn-group" role="group" aria-label="Basic example">
  		<button type="button" class="btn btn-light" onclick="location.href='/board/list'">취 소</button>
