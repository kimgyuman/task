...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
 ...
 <section id="container">
  <form role="form" method="post" autocomplete="off">
   ...
   <p><h2>정말로 삭제하시겠습니까?</h2></p>
   <p>
    <button type="submit" style="margin-top:10px;">예, 삭제합니다.</button><br />
    <button type="button" id="cancel_btn" style="margin-top:30px;">아니오, 삭제하지 않습니다.</button>
